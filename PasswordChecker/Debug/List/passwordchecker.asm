...
_0x3:
	...
	.DB  0x7F,0x6F,0x5C,0x7C,0x39,0x5E,0x79,0x71
_0x4:
	.DB  0x1
_0x5:
	.DB  0x1
_0x0:
	.DB  0x3E,0x20,0x4C,0x45,0x44,0x0,0x42,0x75
	.DB  0x7A,0x7A,0x65,0x72,0x0,0x3E,0x20,0x42
	.DB  0x75,0x7A,0x7A,0x65,0x72,0x0,0x3E,0x20
	.DB  0x52,0x65,0x6C,0x61,0x79,0x0,0x45,0x6E
	.DB  0x74,0x65,0x72,0x20,0x50,0x61,0x73,0x73
	.DB  0x77,0x6F,0x72,0x64,0x3A,0x0,0x25,0x63
	.DB  0x0,0x2A,0x31,0x34,0x23,0x0,0x57,0x72
	.DB  0x6F,0x6E,0x67,0x20,0x70,0x61,0x73,0x73
	.DB  0x77,0x6F,0x72,0x64,0x21,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0022     menuselect++;
	LDI  R26,LOW(_menuselect)
	LDI  R27,HIGH(_menuselect)
	RJMP _0x4B
; 0000 0023 }
; .FEND
;
...
; .FSTART _ext_int1_isr
	CALL SUBOPT_0x0
; 0000 0027     menunext++;
	LDI  R26,LOW(_menunext)
	LDI  R27,HIGH(_menunext)
	RJMP _0x4B
; 0000 0028 }
; .FEND
;
...
; 0000 002C     keypadclicked++;
	LDI  R26,LOW(_keypadclicked)
	LDI  R27,HIGH(_keypadclicked)
_0x4B:
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
...
;	str -> Y+0
	...
	CPC  R0,R9
	BRNE _0x24
	LDS  R30,_passwordPromptShown
	LDS  R31,_passwordPromptShown+1
	SBIW R30,0
	BRNE _0x24
	MOV  R0,R12
	OR   R0,R13
...
; 0000 010D                 passwordPromptShown = 1;
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	STS  _passwordPromptShown,R30
	STS  _passwordPromptShown+1,R31
; 0000 010E             }
; 0000 010F 
...
_0x26:
	LDS  R30,_keypadclicked
	LDS  R31,_keypadclicked+1
	SBIW R30,0
	BRNE PC+2
	RJMP _0x2A
; 0000 011D             {
; 0000 011E                 keypadclicked = 0;
	LDI  R30,LOW(0)
	STS  _keypadclicked,R30
	STS  _keypadclicked+1,R30
...
; 0000 0123                     iputpass[inputcounter] = str[0];
	MOVW R30,R8
	SUBI R30,LOW(-_iputpass)
	SBCI R31,HIGH(-_iputpass)
	LD   R26,Y
	STD  Z+0,R26
...
; 0000 0134                             menutogglereq = 0;
	LDI  R30,LOW(0)
	STS  _menutogglereq,R30
	STS  _menutogglereq+1,R30
...
; 0000 0141                             passwordPromptShown = 0;
	LDI  R30,LOW(0)
	STS  _passwordPromptShown,R30
	STS  _passwordPromptShown+1,R30
; 0000 0142                         }
_0x2F:
; 0000 0143                     }
; 0000 0144                 }
...
; 0000 0160                 menutoggle = 1;
	...
	LDI  R31,HIGH(1)
	STS  _menutoggle,R30
	STS  _menutoggle+1,R31
; 0000 0161             }
; 0000 0162 
; 0000 0163             if (menutogglereq)
_0x34:
	LDS  R30,_menutogglereq
	LDS  R31,_menutogglereq+1
	SBIW R30,0
	BREQ _0x35
; 0000 0164             {
...
;OPTIMIZER ADDED SUBROUTINE, CALLED 3 TIMES, CODE SIZE REDUCTION:1 WORDS
SUBOPT_0x5:
	LDI  R30,LOW(_iputpass)
	LDI  R31,HIGH(_iputpass)
	ST   -Y,R31
	ST   -Y,R30
	RET
