...
int timer, loginchecker, inputcounter, sscounter, iswrong, keypadclicked = 0;
char iputpass[15];
char temp[15];
int menu = 0;
int menu_state = 0;
int menunext, menuselect =0;
int menutodo = ;
int ismain = 1;
int changemenu = 0;
int buzzer = 0;
...
void displayMainMenu()
{
    ...
    switch(menu) {
        case 0:
           lcd_gotoxy(0,0);
            lcd_putsf(">LED Control");
            lcd_gotoxy(1,0); 
            lcd_putsf(" Buzzer Control");
            break;
        case 1:
            lcd_gotoxy(0,); 
            lcd_putsf(">Buzzer Control");
            lcd_gotoxy(0,2); 
            lcd_putsf(" Relay Control");
            break;
        case 2:
            lcd_gotoxy(0,1); lcd_putsf(" Buzzer Control");
            lcd_gotoxy(0,2); lcd_putsf(">Relay Control");
            break;
    }
}
