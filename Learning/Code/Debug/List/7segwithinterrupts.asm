...
; 0000 0027 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
...
; 0000 0036 // Clock value: Timer1 Stopped
...
; 0000 003C // Timer1 Overflow Interrupt: Off
; 0000 003D // Input Capture Interrupt: Off
; 0000 003E // Compare A Match Interrupt: Off
...
; 0000 0049 OCR1BL=0x00;
	OUT  0x28,R30
; 0000 004A 
; 0000 004B // Timer/Counter 2 initialization
; 0000 004C // Clock source: System Clock
; 0000 004D // Clock value: Timer2 Stopped
; 0000 004E // Mode: Normal top=0xFF
; 0000 004F // OC2 output: Disconnected
; 0000 0050 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0051 TCCR2=(0<<PWM2) | (0<<COM21) | (0<<COM20) | (0<<CTC2) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
