...
_0x0:
	.DB  0x56,0x61,0x6C,0x75,0x65,0x3D,0x25,0x64
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 000C i++;
	...
	ADIW R30,1
	MOVW R4,R30
; 0000 000D //sprintf(str,"Value=%d",i);
; 0000 000E //lcd_gotoxy(0,0);
; 0000 000F //lcd_puts(str);
; 0000 0010 }
	LD   R30,Y+
	OUT  SREG,R30
	LD   R31,Y+
...
; 0000 0080 // RS - PORTB Bit 1
; 0000 0081 // RD - PORTB Bit 2
; 0000 0082 // EN - PORTB Bit 3
; 0000 0083 // D4 - PORTB Bit 4
; 0000 0084 // D5 - PORTB Bit 5
; 0000 0085 // D6 - PORTB Bit 6
; 0000 0086 // D7 - PORTB Bit 7
; 0000 0087 // Characters/line: 8
; 0000 0088 lcd_init(8);
	LDI  R26,LOW(8)
	RCALL _lcd_init
; 0000 0089 
...
; 0000 0093       t++;
	...
	ADIW R30,1
	MOVW R6,R30
; 0000 0094       sprintf(str,"Value=%d",t);
	LDI  R30,LOW(_str)
	LDI  R31,HIGH(_str)
	ST   -Y,R31
	ST   -Y,R30
