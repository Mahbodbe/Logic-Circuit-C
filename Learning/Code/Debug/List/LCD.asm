...
_0x0:
	.DB  0x41,0x56,0x52,0x0,0x4C,0x43,0x44,0x20
	.DB  0x54,0x45,0x53,0x54,0x21,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0074 // RS - PORTB Bit 0
; 0000 0075 // RD - PORTB Bit 1
; 0000 0076 // EN - PORTB Bit 2
; 0000 0077 // D4 - PORTB Bit 4
; 0000 0078 // D5 - PORTB Bit 5
; 0000 0079 // D6 - PORTB Bit 6
; 0000 007A // D7 - PORTB Bit 7
...
; 0000 0085       lcd_gotoxy(5,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 0086       lcd_putsf("LCD TEST!");
	__POINTW2FN _0x0,4
	RCALL SUBOPT_0x0
; 0000 0087       delay_ms(1000);
; 0000 0088       lcd_clear();
; 0000 0089       }
	RJMP _0x3
; 0000 008A }
